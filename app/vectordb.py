...
# embedding_model = HuggingFaceEmbeddings(model_name="paraphrase-multilingual-MiniLM-L12-v2")
# test = Chroma(embedding_function=embedding_model,persist_directory='app/vectorDB')

# query = ["Navait pas de clignotant","Bossage capot" ,"Lunette arrière endommagée", "Etait trop lent"]

# for q in query:
#     r=test.similarity_search(q,k=1)
#     print(q,":",r)
